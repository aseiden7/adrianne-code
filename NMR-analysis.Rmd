...
theme_suffix <- "-dark"  # Change to "-dark" when using theme_dark_custom()
annotation_text_color <- ifelse(theme_suffix == "-dark", "white", "black")  # Change to "white" when using theme_dark_custom()
...
crop_timepoint_colors <- list(
  wheat = c("wk0" ="#D8B1FB", "wk10" = "#BD7EF6", "wk40" = "#3f0477"),
  rice = c("wk0" = "#ffad4f", "wk10" = "#F08F20", "wk40" = "#B56203"),
...
crop_color <- c("soy" = "#FE318E", "rice" = "#FC9D33", "wheat" = "#8c4dc3")
...
bonanomi_regions <- data.frame(
  ...
  color = c("#555553", "#aab49d", "#5d5d5b", "#bbc7b3", "#73746d", "#c0cdbc", "#909583")
)
