...
# Save the plot
ggsave(filename = file.path(outputs_folder, "RDR_vs_Alkyl-O-Alkyl_ratio.png"),
...
# Save the plot
ggsave(filename = file.path(outputs_folder, "NMR_spectra_averaged_annotated.png"),
...
# Save the plot
ggsave(filename = file.path(outputs_folder, "NMR_spectra_suber_region_0-172ppm.png"),
       plot = p_suber, width = 12, height = 6, dpi = 300)
...
# Save the plot
ggsave(filename = file.path(outputs_folder, "NMR_spectra_aSub_17-40ppm.png"),
