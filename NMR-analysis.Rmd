...
RDR is calculated according to Phung et al. (in review) $(alkyl + aromatic and phenolic)/(O-alkyl + carboxyl and carbonyl carbon)$. Using the Bonanomi integration regions, this corresponds to $(0-45 ppm + 111-160 ppm)/(61-90 ppm + 161-190 ppm)$, but Phung et al. (in review) uses $(0--45 ppm + 110--165 ppm)/(60--95 ppm + 165--215 ppm)$ for their calculations.
...
# Plot Alkyl/O-Alkyl (A/O-A) and Resistance-to-decomposition (RDR) Ratios Over Time
