...
bonanomi_regions <- data.frame(
  ...
  color = rainbow(7, start = 0.1, end = 0.9)
)
...
p_suber <- ggplot(spectra_stats_suber, aes(x = ppm, y = mean_intensity, color = crop_time, fill = crop_time)) +
  ...
  geom_vline(xintercept = 172, linetype = "dotted", color = "#555555", linewidth = 0.65) +
...
p_alkyl <- ggplot(spectra_stats_alkyl, aes(x = ppm, y = mean_intensity, color = crop_time, fill = crop_time)) +
  ...
  geom_line(linewidth = 0.8) +
  # Add vertical reference lines
  geom_vline(xintercept = 33, linetype = "dotted", color = "#5e5e5e", linewidth = 0.7) +
  geom_vline(xintercept = 30, linetype = "dotted", color = "#5e5e5e", linewidth = 0.7) +
  facet_grid(timepoint ~ crop, scales = "free_y") +
  scale_x_reverse() +
  scale_color_manual(values = color_map) +
  scale_fill_manual(values = color_map) +
