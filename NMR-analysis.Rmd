...
plot_data <- ratios_df %>%
  ...
  mutate(
    ...
    crop_time = interaction(crop, timepoint)
  )

# Create named color vector for all crop-timepoint combinations
color_mapping <- c(
  "soy.wk0" = crop_timepoint_colors$soy["wk0"],
  "soy.wk10" = crop_timepoint_colors$soy["wk10"],
  "soy.wk40" = crop_timepoint_colors$soy["wk40"],
  "rice.wk0" = crop_timepoint_colors$rice["wk0"],
  "rice.wk10" = crop_timepoint_colors$rice["wk10"],
  "rice.wk40" = crop_timepoint_colors$rice["wk40"],
  "wheat.wk0" = crop_timepoint_colors$wheat["wk0"],
  "wheat.wk10" = crop_timepoint_colors$wheat["wk10"],
  "wheat.wk40" = crop_timepoint_colors$wheat["wk40"]
)
