...
root0_plot <- root0 %>%
  ...
  geom_vline(xintercept = 1737, linetype = "dashed", linewidth = 0.75) +
  xlim(4000, 400) +
  theme_classic() +
...
root0_plot
unique(root0$ID)
ggsave(file.path(outputs_folder, "Root_week0_ATR.png"), plot = root0_plot)
...
ggsave(file.path(outputs_folder, "Soil_week0_ATR.png"), plot = soil0_plot) # nolint
```
...
root10_plot
unique(root10$ID)
ggsave(file.path(outputs_folder, "Root_week10_ATR.png"), plot = root10_plot)
...
soil10_plot
unique(soil10$ID)
ggsave(file.path(outputs_folder, "Soil_week10_ATR.png"), plot = soil10_plot)
```
...
root40_plot
unique(root40$ID)
ggsave(file.path(outputs_folder, "Root_week40_ATR.png"), plot = root40_plot)
