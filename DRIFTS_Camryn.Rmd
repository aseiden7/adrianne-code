...
ID = case_when(
  ...
  filter(!filename %in% c("DRIFTS_pot079_13Crice_wk0_root_250725.0.dpt",
...
cat("RhizoSoil samples by crop:\n")
print(table(dpt_data_rhizo$crop))
cat("RhizoSoil samples by timepoint:\n") 
print(table(dpt_data_rhizo$timepoint))
...
interaction_plot <- ggplot(crop_timepoint_stats) +
  ...
  geom_errorbar(aes(x = crop,
                    ...
                    ymax = Mean_simple_plant_prop + SE_simple_plant_prop,
                    group = timepoint),
                position = position_dodge(0.9), width = 0.2, color = annotation_line_color) +
