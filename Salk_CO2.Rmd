...
plt.xlabel('Sampling Week', fontsize=15);
plt.ylabel(r'$\mathrm{atom-\% \,^{13}C}$', fontsize=15);
...
plt.xlabel('Sampling Week', fontsize=15);
plt.ylabel(r'$\mathrm{CO_2}$ flux $\mathrm{(μg CO_2}$-$\mathrm{C \cdot g}$-$\mathrm{soil^{-1} \cdot minute^{-1}})$', fontsize=15);
