...
Sys.setenv(BOX_BASE = "/Users/adrianneseiden/Library/Cloud Storage/Box-Box")
library(reticulate)
...
# Remove leading slash from the second argument to os.path.join
...
plt.tight_layout()
plt.savefig('jars_analysis_plots_VPDB.png', dpi=300)
...
# Adjust layout and save figure
plt.tight_layout()
plt.savefig('jars_analysis_plots_at-pct.png', dpi=300)
...
# Save the figure
plt.savefig('jars_cumul_co2_flux_by_crop_no_filter.png', dpi=300, bbox_inches='tight')
...
# Save the figure
plt.savefig('jars_cumul_co2_flux_by_crop_filtered.png', dpi=300, bbox_inches='tight')
...
# Adjust layout and save figure
plt.tight_layout()
plt.savefig('pots_analysis_plots_VPDB.png', dpi=300)
...
# Adjust layout and save figure
plt.tight_layout()
plt.savefig('pots_analysis_plots_at-pct.png', dpi=300)
...
# Adjust layout and save figure
plt.tight_layout()
plt.savefig('pots_co2_flux_by_crop.png', dpi=300, bbox_inches='tight')
...
# Save the figure
plt.savefig('pots_cumul_co2_flux_by_crop.png', dpi=300, bbox_inches='tight')
