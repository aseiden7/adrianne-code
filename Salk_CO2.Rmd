...
colors = ['#FC9D33', '#FE318E','#0CB2AF','#3C57DE', '#98C65D','#9F29FF']   # orange, pink, teal, blue, green, purple
...
#num_combinations = len(crop_isotope_combinations)
#colors = sns.color_palette('husl', num_combinations)
colors = ['#3C57DE', '#98C65D', '#9F29FF','#FC9D33', '#FE318E','#0CB2AF']   # blue, green, purple, orange, pink, teal
