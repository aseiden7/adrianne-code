---
title: "DRIFTS Experiment: SNV instead of max normalization"
...
## Normalizing data
This code is modified to only use baseline correction (subtracting the minimum) and skip normalization to the maximum absorbance value.
```{r normalize-data}
