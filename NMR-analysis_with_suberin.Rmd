...
theme_dark_custom <- function() {
  ...
  theme(
    ...
    axis.line = element_line(color = "#e6e6e6", linewidth = 0.36),
    panel.grid.major.y = element_line(color = "#565656", linewidth = 0.3),
    panel.grid.minor.y = element_line(color = "#3e3e3e", linewidth = 0.2),
