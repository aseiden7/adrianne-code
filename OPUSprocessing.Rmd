...
library(ggsignif)
# # Mac wd
# setwd("/Users/adrianneseiden/Library/CloudStorage/Box-Box/Salk Institute Project/AKS Salk files/Adrianne_FTIRdata") # nolint
# # Windows wd
# setwd("C:/Users/adria/Box/Salk Institute Project/AKS Salk files/Adrianne_FTIRdata") # nolint
# set Box path
box_base <- Sys.getenv("BOX_BASE")
if (box_base == "") stop("BOX_BASE environment variable is not set!")
# set dpt_folder path
...
# Set data folder
# # Mac path
# dpt_folder <- "/Users/adrianneseiden/Library/CloudStorage/Box-Box/Salk Institute Project/AKS Salk files/Adrianne_FTIRdata/DPT_files" # nolint
# # Windows path
# dpt_folder <- "C:/Users/adria/Box/Box-Box/Salk Institute Project/AKS Salk files/Adrianne_FTIRdata/DPT_files" # nolint
# # Relative path
...
today <- Sys.Date()
csvName <- paste0("FTIR_wide_", today, ".csv") # nolint: object_name_linter.
...
# Save to CSV with today's date
today <- Sys.Date()
csvName2 <- paste0("FTIR_wide_info_", # nolint: object_name_linter.
                   today, ".csv")
...
root0_plot
unique(root0$ID)
ggsave("Root_week0_FTIR.png", plot = root0_plot)
...
# ggsave("Soil_week0_FTIR.png", plot = soil0_plot) # nolint
```
...
root10_plot
unique(root10$ID)
ggsave("Root_week10_FTIR.png", plot = root10_plot)
...
soil10_plot
unique(soil10$ID)
ggsave("Soil_week10_FTIR.png", plot = soil10_plot)
```
## Plotting by crop
### wheat roots
