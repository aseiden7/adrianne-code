...
anomalous_spectra <- "DRIFTS_pot103_13Crice_wk0_root_recNMR_250725.0.dpt"
...
anomalous_files <- "DRIFTS_pot103_13Crice_wk0_root_recNMR_250725.0.dpt"
...
ints[1] <- meta_table[, 1]  # source
ints[2] <- meta_table[, 2]  # ID
ints[3] <- meta_table[, 3]  # isotope
ints[4] <- meta_table[, 4]  # crop
ints[5] <- meta_table[, 5]  # timepoint
ints[6] <- meta_table[, 6]  # type
ints[7] <- meta_table[, 7]  # notes
ints[8] <- meta_table[, 8]  # run_date
...
calculate_group_stats <- function(data, group_vars) {
  data %>%
    ...
    summarise(
      ...
      SD_microbial_prop = sd(microbial_plant_prop, na.rm = TRUE),
