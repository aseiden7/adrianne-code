...
wk40_wheat_root_data <- ftir_data[ftir_data$crop == "wheat" & ftir_data$timepoint == "wk40", ]
...
wk40_rice_root_data <- ftir_data[ftir_data$crop == "rice" & ftir_data$timepoint == "wk40", ]
...
wk40_soy_root_data <- ftir_data[ftir_data$crop == "soy" & ftir_data$timepoint == "wk40", ]
...
create_proportion_plots <- function(stats_data, group_col, title_prefix) {
  ...
  crop_colors <- c('wheat' = '#98C65D', 'rice' = '#FC9D33', 'soy' = '#FE318E')
  # Use the same timepoint colors as interaction plot
  timepoint_colors <- c("#440154", "#31688e", "#9FB8AD", "#F9A03F", "#D5C6E0")
...
interaction_plot <- ggplot(crop_timepoint_stats) +
  ...
  theme_classic() +
  scale_fill_manual("Timepoint", values = c("#440154", "#31688e", "#9FB8AD", "#F9A03F")) +
