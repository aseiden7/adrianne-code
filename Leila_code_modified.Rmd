...
anomalous_spectra <- c("DRIFTS_pot094_13Csoy_wk10_root_250725.0.dpt",
                     "DRIFTS_pot107_12Crice_wk0_root_really13_250725.0.dpt")
...
anomalous_files <- c("DRIFTS_pot094_13Csoy_wk10_root_250725.0.dpt",
                     "DRIFTS_pot107_12Crice_wk0_root_really13_250725.0.dpt")
...
#wk20_wheat_root_data <- ftir_data[ftir_data$crop == "wheat" & ftir_data$timepoint == "wk20", ]
#wk30_wheat_root_data <- ftir_data[ftir_data$crop == "wheat" & ftir_data$timepoint == "wk30", ]
...
#wk30_rice_root_data <- ftir_data[ftir_data$crop == "rice" & ftir_data$timepoint == "wk29", ]
...
#wk20_soy_root_data <- ftir_data[ftir_data$crop == "soy" & ftir_data$timepoint == "wk20", ]
#wk30_soy_root_data <- ftir_data[ftir_data$crop == "soy" & ftir_data$timepoint == "wk30", ]
wk40_soy_root_data <- ftir_data[ftir_data$crop == "soy" & ftir_data$timepoint == "wk40", ]

#wk30_noPlant_root_data <- ftir_data[ftir_data$crop == "noPlant" & ftir_data$timepoint == "wk30", ]
#wk40_noPlant_root_data <- ftir_data[ftir_data$crop == "noPlant" & ftir_data$timepoint == "wk40", ]
...
create_proportion_plots <- function(stats_data, group_col, title_prefix) {
  ...
  crop_colors <- c('wheat' = '#98C65D', 'rice' = '#FC9D33', 'soy' = '#FE318E', 'noPlant' = '#2E4057')
...
interaction_plot <- ggplot(crop_timepoint_stats) +
  ...
  theme_classic() +
  scale_fill_manual("Timepoint", values = c("#440154", "#31688e", "#9FB8AD", "#F9A03F", "#D5C6E0")) +
